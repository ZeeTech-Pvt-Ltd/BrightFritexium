...
const CONTENT = {
  ...
  keywords: ['BrightFritexium privacy policy', 'data protection Australia'],
  sections: [
    {
      h: '1. Who we are',
      p: 'BrightFritexium ("we", "us") operates the website brightfritexium.io and the digital wealth services described on it. For the purposes of the Australian Privacy Act 1988 (Cth), we are the data controller of the personal information described in this policy.',
    },
    {
