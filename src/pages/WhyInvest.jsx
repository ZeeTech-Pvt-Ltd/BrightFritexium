...
export default function WhyInvest() {
  useMeta({
    title: 'Why Invest | BrightFritexium - Protection at Every Layer',
    description:
      'Segregated vaults, regulated custodians, cold storage and audited controls - see why Australian members choose BrightFritexium for digital wealth.',
    path: '/why-invest',
    keywords: ['why invest in crypto Australia', 'secure crypto custody', 'BrightFritexium security'],
  });
      ...
      <div className="container">
        <Reveal>
          ...
          <p className="section-lead" style={{ maxWidth: 720 }}>
            Most platforms ask you to trust them. We built BrightFritexium so you do not have
      ...
      <div className="container" style={{ marginTop: 72 }}>
        <Reveal>
          ...
          <h2 className="section-title" style={{ maxWidth: 720, marginBottom: 20 }}>
            Everything your wealth needs, in one account
          </h2>
        </Reveal>
