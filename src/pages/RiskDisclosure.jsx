...
const CONTENT = {
  ...
  keywords: ['BrightFritexium risk disclosure', 'crypto investment risk Australia'],
  sections: [
    {
      h: '1. Capital at risk',
    ...
    },
    {
      ...
      p: 'Crypto asset services in Australia are subject to evolving regulation under ASIC and AUSTRAC rules. BrightFritexium operates with regulated custodial partners and audited controls, but crypto assets themselves remain largely unregulated instruments. Rules may change and affect your holdings.',
    },
    {
