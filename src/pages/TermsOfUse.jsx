...
const CONTENT = {
  ...
  keywords: ['BrightFritexium terms of use', 'platform terms Australia'],
  sections: [
    {
      h: '1. Agreement',
      p: 'By using brightfritexium.io and the BrightFritexium platform you agree to these Terms of Use. If you do not agree, please do not use the service. These terms apply alongside our Privacy Policy and Risk Disclosure, which form part of the agreement between us.',
    },
    {
      h: '2. Eligibility',
    ...
    },
    {
      ...
      p: 'All content on this site - text, graphics, logos and software - belongs to BrightFritexium or its licensors. You may view and use it for personal, non-commercial purposes only.',
    },
    {
    ...
    },
    {
      ...
      p: 'To the maximum extent permitted by law, BrightFritexium is not liable for losses arising from market movements, your use of the service, or events outside our reasonable control. Nothing in these terms limits liability for fraud or for anything that cannot be limited by Australian law.',
    },
    {
