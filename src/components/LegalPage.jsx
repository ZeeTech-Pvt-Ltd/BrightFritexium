...
export default function LegalPage({ content, path }) {
  useMeta({
    title: content.seoTitle || `${content.title} | BrightFritexium`,
    description:
      content.description ||
      `${content.title} for the BrightFritexium digital wealth platform - secure crypto investing for Australia.`,
    path,
